...
export type StorageHash =
  StorageHashBase<'d796782d1a7741b45ddcef979230e17f30d4393e8dfc30da23d188789662ec9d'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly CartItem: {
      ...
      readonly materialId: CodecTypes['pg/int4@1']['output'];
    ...
    readonly Order: {
      ...
      readonly total: CodecTypes['pg/text@1']['output'];
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['output'];
      readonly updatedAt: CodecTypes['pg/timestamptz-string@1']['output'];
    };
    readonly OrderItem: {
    ...
    readonly ReadingProgress: {
      ...
      readonly userId: CodecTypes['pg/int4@1']['output'];
      readonly materialId: CodecTypes['pg/int4@1']['output'];
      readonly currentPage: CodecTypes['pg/int4@1']['output'];
      readonly totalPages: CodecTypes['pg/int4@1']['output'];
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly CartItem: {
      ...
      readonly materialId: CodecTypes['pg/int4@1']['input'];
    ...
    readonly Order: {
      ...
      readonly total: CodecTypes['pg/text@1']['input'];
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['input'];
      readonly updatedAt: CodecTypes['pg/timestamptz-string@1']['input'];
    };
    readonly OrderItem: {
    ...
    readonly ReadingProgress: {
      ...
      readonly userId: CodecTypes['pg/int4@1']['input'];
      readonly materialId: CodecTypes['pg/int4@1']['input'];
      readonly currentPage: CodecTypes['pg/int4@1']['input'];
      readonly totalPages: CodecTypes['pg/int4@1']['input'];
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly cartItem: {
              ...
              primaryKey: { readonly columns: readonly ['id'] };
              uniques: readonly [{ readonly columns: readonly ['cartId', 'materialId'] }];
              indexes: readonly [
                {
                ...
                {
                  readonly name: 'cartItem_materialId_idx_e0f85a6d';
                  readonly prefix: 'cartItem_materialId_idx';
            ...
            readonly orderItem: {
              ...
              indexes: readonly [
                ...
                {
                  readonly name: 'orderItem_materialId_idx_e0f85a6d';
                  readonly prefix: 'orderItem_materialId_idx';
                  readonly columns: readonly ['materialId'];
                  readonly unique: false;
                },
              ];
            ...
            readonly readingProgress: {
              ...
              primaryKey: { readonly columns: readonly ['id'] };
              uniques: readonly [{ readonly columns: readonly ['userId', 'materialId'] }];
              indexes: readonly [
                {
                ...
                {
                  readonly name: 'readingProgress_materialId_idx_e0f85a6d';
                  readonly prefix: 'readingProgress_materialId_idx';
                  readonly columns: readonly ['materialId'];
                  readonly unique: false;
                },
              ];
          ...
          readonly ReadingProgress: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly userId: { readonly column: 'userId' };
                readonly materialId: { readonly column: 'materialId' };
                readonly currentPage: { readonly column: 'currentPage' };
                readonly totalPages: { readonly column: 'totalPages' };
