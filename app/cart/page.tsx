    ...
    try {
      ...
      setItems((currentItems) =>
        currentItems.map((currentItem) =>
          currentItem.material.id === materialId
            ? {
              ...currentItem,
              quantity,
            }
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          <div className="mt-3 flex items-center justify-between border-t border-slate-100 pt-3">
                            ...
                            <div className="flex items-center gap-4">
                              <div className="flex items-center rounded-lg border border-slate-200 bg-[#f7f8fa]">
                                <button
                                  onClick={() =>
                                    updateQuantity(
                                      item.material.id,
                                  ...
                                  className="flex h-7 w-7 cursor-pointer items-center justify-center text-sm font-medium text-slate-500 transition hover:text-[#00256f] disabled:cursor-not-allowed disabled:opacity-40"
                                  aria-label="Decrease quantity"
                                >
                                  −
                                </button>

                                <span className="flex h-7 min-w-7 items-center justify-center border-x border-slate-200 px-2 text-xs font-semibold text-[#071c49]">
                                  {item.quantity}
                                </span>
                                ...
                                <button
                                  ...
                                  className="flex h-7 w-7 cursor-pointer items-center justify-center text-sm font-medium text-slate-500 transition hover:text-[#00256f]"
                                ...
                                onClick={async () => {
                                  try {
                                    ...
                                    setItems((currentItems) =>
                                      currentItems.filter(
                                        (currentItem) =>
                                          currentItem.material.id !== item.material.id
                                      )
                                    );
